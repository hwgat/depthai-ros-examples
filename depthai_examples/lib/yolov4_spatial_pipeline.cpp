...
void YoloSpatialDetectionExample::initDepthaiDev(std::string nnPath, std::string mxID){
    ...
    _dev_info = std::get<1>(dai::Device::getDeviceByMxId(mxID));

    _dev = std::make_unique<dai::Device>(_p,_dev_info);
